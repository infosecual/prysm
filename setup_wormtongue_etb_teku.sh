...
cp etb-fuzzer-images/wormtongue/configs/mainnet-current-wormtongue-teku.yaml ethereum-testnet-bootstrapper/configs
...
make clean config=configs/mainnet-current-wormtongue-teku.yaml
make init-testnet config=configs/mainnet-current-wormtongue-teku.yaml
