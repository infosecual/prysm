...
cp etb-fuzzer-images/wormtongue/configs/mainnet-current-wormtongue-prysm.yaml ethereum-testnet-bootstrapper/configs
...
make clean config=configs/mainnet-current-wormtongue-prysm.yaml
make init-testnet config=configs/mainnet-current-wormtongue-prysm.yaml
